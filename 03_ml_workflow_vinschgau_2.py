...
with rasterio.open(
    r"C:\Users\Basti\Documents\Projekt_Waldbrand\wald\output_data\predicted_labels_jasper_full_2.tif",
    "w",
    driver="GTiff",
    crs=template["crs"],
...
# read metadata of ONE BAND raster for output (damit es 1:1 zum ganzen Bild passt)
template = {}
template_raster = r"C:\Users\Basti\Documents\Projekt_Waldbrand\wald\vinschgau_2\resampled\rs_2025-04-30-00_00_2025-04-30-23_59_Sentinel-2_L2A_B02_(Raw).tiff"
